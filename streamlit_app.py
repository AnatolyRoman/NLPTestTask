...
st.markdown('<h1 style="text-align: left; font-family: Gill Sans; color: #FF69B4">Вывод:</h1>', unsafe_allow_html=True)
st.markdown('<h1 style="text-align: left; font-family: Gill Sans; color: #FF2A00"></h1>', unsafe_allow_html=True)
st.markdown('<p style="text-align: left; font-family: Gill Sans; font-size: 20px; color: #D8D8D8">'
            'Выводы из проведенного эксперимента:'
            'Исходя из сравнения метрик, модель 2 оказалась более успешной в классификации эмоций на текстовых данных по '
            'сравнению с моделью 1. Она показала более высокую точность, метрики precision, recall, F1-меру и MCC. '
            'Это говорит о том, что модель 2 лучше справляется с определением эмоций в тексте и имеет более '
            'сбалансированную производительность.</p>', unsafe_allow_html=True)

st.markdown('<h2 style="text-align: left; font-family: Gill Sans; color: #FF69B4">Развитие данного эксперимента:</h2>', unsafe_allow_html=True)
st.markdown('<p style="text-align: left; font-family: Gill Sans; font-size: 20px; color: #D8D8D8">'
            'Для дальнейшего развития данного эксперимента можно рассмотреть следующие аспекты:</p>', unsafe_allow_html=True)

st.markdown('<ul style="text-align: left; font-family: Gill Sans; font-size: 20px; color: #D8D8D8">'
            '<li>Дополнительная настройка модели: Попробовать различные архитектуры нейронных сетей, гиперпараметры, '
            'функции активации и оптимизаторы для оптимизации производительности моделей.</li>'
            '<li>Использование предобученных эмбеддингов: Попробовать использовать предварительно обученные '
            'эмбеддинги слов, такие как Word2Vec или GloVe, чтобы улучшить представление слов и повысить '
            'производительность модели.</li>'
            '<li>Расширение обучающего набора данных: Собрать или добавить больше разнообразных текстовых данных '
            'для обучения моделей. Это может помочь моделям лучше обобщать и улучшить их производительность.</li>'
            '<li>Ансамбль моделей: Рассмотреть использование ансамбля моделей, где несколько моделей комбинируются для '
            'принятия окончательного решения. Это может помочь улучшить общую производительность и стабильность '
            'предсказаний.</li>'
            '<li>Интерпретация результатов: Исследовать методы интерпретации результатов моделей, такие как анализ '
            'важности признаков или визуализация активации, чтобы лучше понять, какие слова или фразы влияют на '
            'классификацию эмоций.</li>'
            '</ul>', unsafe_allow_html=True)

st.markdown('')
st.markdown('<h3 style="text-align: right; font-family: Gill Sans; color: #fd7e14">by Ròman Anatoly</h3>', unsafe_allow_html=True)
